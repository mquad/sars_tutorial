...
class Markov_tests(unittest.TestCase):
    ...
    def test_add_nodes(self):
        ...
        assert set(G.nodes()) == set(
            [('1', '3', '1'), ('2', '3', '1'), ('1', '1', '3'), ('3', '1', '1'), ('3', '1'), ('3', '1', '3'),
             ('3', '3', '1'), ('1', '3'), ('1', '4'), ('3',), ('3', '1', '4')])
    ...
    def test_add_edges(self):
        ...
        assert set(G_with_edges.nodes()) == set(
            [('1', '3', '1'), ('2', '3', '1'), ('1', '1', '3'), ('3', '1', '1'), ('3', '1'), ('3', '1', '3'),
             ('3', '3', '1'), ('1', '3'), ('1', '4'), ('3',), ('3', '1', '4')])

        ## check edges
        true_edges = [((('3',), ('3', '1')), 1), ((('3', '1'), ('3', '1', '1')), 4), ((('3', '1'), ('3', '1', '4')), 1),
                      ((('3', '1'), ('3', '1', '3')), 2), ((('1', '3'), ('1', '3', '1')), 4),
                      ((('1', '1', '3'), ('1', '3', '1')), 2), ((('3', '1', '1'), ('1', '1', '3')), 2),
                      ((('3', '1', '3'), ('1', '3', '1')), 1), ((('1', '3', '1'), ('3', '1', '3')), 1),
                      ((('1', '3', '1'), ('3', '1', '1')), 2), ((('2', '3', '1'), ('3', '1', '1')), 1),
                      ((('2', '3', '1'), ('3', '1', '4')), 1),
                      ((('2', '3', '1'), ('3', '1', '3')), 1)]
    ...
    def test_fractional_count(self):
        ...
        true_edges_normalized = [((('3',), ('3', '1')), 1), ((('3', '1'), ('3', '1', '1')), 4 / 7),
                                 ((('3', '1'), ('3', '1', '4')), 1 / 7), ((('3', '1'), ('3', '1', '3')), 2 / 7),
                                 ((('1', '3'),
                                   ('1', '3', '1')), 1), ((('1', '1', '3'), ('1', '3', '1')), 1),
                                 ((('3', '1', '1'), ('1', '1', '3')), 1), ((('3', '1', '3'), ('1', '3', '1')), 1),
                                 ((('1', '3', '1'), ('3', '1', '3')), 1 / 3),
                                 ((('1', '3', '1'), ('3', '1', '1')), 2 / 3),
                                 ((('2', '3', '1'), ('3', '1', '1')), 1 / 3),
                                 ((('2', '3', '1'), ('3', '1', '4')), 1 / 3),
    ...
    def test_clusterting(self):
        ...
        true_similarity_dict = {(('3',), ('3', '1')): 2, (('3',), ('3', '1', '1')): 2, (('3',), ('3', '1', '4')): 2,
                                (('3',), ('3', '1', '3')): 2, (('3',), ('3', '3', '1')): 2,
                                (('3', '1'), ('3',)): 2, (('3', '1', '1'), ('3',)): 2, (('3', '1', '4'), ('3',)): 2,
                                (('3', '1', '3'), ('3',)): 2, (('3', '3', '1'), ('3',)): 2,
                                (('1', '3'), ('1', '4')): 2, (('1', '3'), ('1', '1', '3')): 2,
                                (('1', '3'), ('1', '3', '1')): 5, (('1', '3'), ('2', '3', '1')): 3,
                                (('1', '3'), ('3', '3', '1')): 3,
                                (('1', '4'), ('1', '3')): 2, (('1', '1', '3'), ('1', '3')): 2,
                                (('1', '3', '1'), ('1', '3')): 5, (('2', '3', '1'), ('1', '3')): 3,
                                (('3', '3', '1'), ('1', '3')): 3,
                                (('3', '1'), ('1', '1', '3')): 3, (('3', '1'), ('3', '1', '1')): 5,
                                (('3', '1'), ('3', '1', '4')): 5, (('3', '1'), ('3', '1', '3')): 5,
                                (('3', '1'), ('3', '3', '1')): 2,
                                (('1', '1', '3'), ('3', '1')): 3, (('3', '1', '1'), ('3', '1')): 5,
                                (('3', '1', '4'), ('3', '1')): 5, (('3', '1', '3'), ('3', '1')): 5,
                                (('3', '3', '1'), ('3', '1')): 2,
                                (('1', '4'), ('1', '1', '3')): 2, (('1', '4'), ('1', '3', '1')): 2,
                                (('1', '1', '3'), ('1', '4')): 2, (('1', '3', '1'), ('1', '4')): 2,
                                (('1', '1', '3'), ('3', '1', '1')): 3, (('1', '1', '3'), ('3', '1', '4')): 3,
                                (('1', '1', '3'), ('3', '1', '3')): 7, (('1', '1', '3'), ('1', '3', '1')): 2,
                                (('3', '1', '1'), ('1', '1', '3')): 3, (('3', '1', '4'), ('1', '1', '3')): 3,
                                (('3', '1', '3'), ('1', '1', '3')): 7, (('1', '3', '1'), ('1', '1', '3')): 2,
                                (('3', '1', '1'), ('3', '1', '4')): 5, (('3', '1', '1'), ('3', '1', '3')): 5,
                                (('3', '1', '1'), ('1', '3', '1')): 4, (('3', '1', '1'), ('2', '3', '1')): 4,
                                (('3', '1', '1'), ('3', '3', '1')): 6,
                                (('3', '1', '4'), ('3', '1', '1')): 5, (('3', '1', '3'), ('3', '1', '1')): 5,
                                (('1', '3', '1'), ('3', '1', '1')): 4, (('2', '3', '1'), ('3', '1', '1')): 4,
                                (('3', '3', '1'), ('3', '1', '1')): 6,
        ...
        true_similarity_count_dict = {(('3',), ('1', '1', '3')): 2, (('3',), ('3', '1', '1')): 2 * 4 / 7,
                                      (('3',), ('3', '1', '4')): 2 * 1 / 7, (('3',), ('3', '1', '3')): 2 * 2 / 7,
                                      (('3',), ('1', '3', '1')): 2,
                                      (('1', '3'), ('3', '1', '1')): 1 + 5 * 2 / 3, (('1', '3'), ('3', '1', '4')): 1,
                                      (('1', '3'), ('3', '1', '3')): 5 * 1 / 3 + 1, (('1', '3'), ('1', '3', '1')): 2,
                                      (('3', '1'), ('1', '1', '3')): 5, (('3', '1'), ('1', '3', '1')): 8,
                                      (('1', '4'), ('3', '1', '1')): 4 / 3, (('1', '4'), ('3', '1', '3')): 2 / 3,
                                      (('1', '4'), ('1', '3', '1')): 4,
                                      (('1', '1', '3'), ('3', '1', '1')): 3 * 4 / 7 + 4 / 3,
                                      (('1', '1', '3'), ('3', '1', '4')): 3 / 7,
                                      (('1', '1', '3'), ('3', '1', '3')): 6 / 7 + 2 / 3,
                                      (('1', '1', '3'), ('1', '3', '1')): 9,
                                      (('3', '1', '1'), ('3', '1')): 2,
                                      (('3', '1', '1'), ('3', '1', '4')): 5 / 7 + 4 / 3,
                                      (('3', '1', '1'), ('3', '1', '3')): 4 / 3 + 10 / 7 + 4 / 3,
                                      (('3', '1', '1'), ('1', '3', '1')): 8,
                                      (('3', '1', '4'), ('3', '1')): 2, (('3', '1', '4'), ('1', '1', '3')): 5,
                                      (('3', '1', '4'), ('3', '1', '1')): 20 / 7,
                                      (('3', '1', '4'), ('3', '1', '3')): 10 / 7, (('3', '1', '4'), ('1', '3', '1')): 8,
                                      (('3', '1', '3'), ('3', '1')): 2, (('3', '1', '3'), ('1', '1', '3')): 5,
                                      (('3', '1', '3'), ('3', '1', '1')): 20 / 7,
                                      (('3', '1', '3'), ('3', '1', '4')): 5 / 7, (('3', '1', '3'), ('1', '3', '1')): 7,
                                      (('1', '3', '1'), ('1', '1', '3')): 4, (('1', '3', '1'), ('3', '1', '1')): 7 / 3,
                                      (('1', '3', '1'), ('3', '1', '4')): 7 / 3,
                                      (('1', '3', '1'), ('3', '1', '3')): 7 / 3,
                                      (('2', '3', '1'), ('1', '1', '3')): 4, (('2', '3', '1'), ('3', '1', '1')): 14 / 3,
                                      (('2', '3', '1'), ('3', '1', '3')): 7 / 3, (('2', '3', '1'), ('1', '3', '1')): 3,
                                      (('3', '3', '1'), ('3', '1')): 2, (('3', '3', '1'), ('1', '1', '3')): 6,
                                      (('3', '3', '1'), ('3', '1', '1')): 8 / 7 + 14 / 3 + 7 / 3,
                                      (('3', '3', '1'), ('3', '1', '4')): 7 / 3 + 2 / 7,
                                      (('3', '3', '1'), ('3', '1', '3')): 14 / 3 + 4 / 7,
                                      (('3', '3', '1'), ('1', '3', '1')): 5}
    ...
    def test_mixed_model_rec(self):
        ...
        self.list_equal(r.get_recommendation_confidence_list(r.recommend(['2', '2'])),
                        [0.3 * 0.5 / 1.5, 0.4 / 1.5, 0.95 / 1.5])
        ...
        self.list_equal(r.get_recommendation_confidence_list(r.recommend(['2'])),
                        [0.4 / 1.5, 0.65 / 1.5, 0.2 / 1.5, 0.25 / 1.5])
