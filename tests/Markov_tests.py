...
t,count_dict,G = add_nodes_to_graph(seqs,3)
...
G_with_edges = add_edges(t,count_dict,G,t.get_root(),3)
...
G_fractional_added = add_fractional_count(G_with_edges,3,seqs)
...
for e in true_edges_final:
        ...
        assert e[1] == G_clustered[e[0][0]][e[0][1]]['count']
